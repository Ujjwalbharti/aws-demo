...
public class MessageController {
    ...
    public ResponseEntity<String> sendMessage(@Valid @RequestBody MessageRequest messageRequest) throws Exception {
    ...
    public ResponseEntity<String> acknowledgeMessage(@Valid @RequestBody AcknowledgeMessageRequest messageRequest) throws Exception {
        messageService.acknowledgeMessage(messageRequest);
        return ResponseEntity.status(HttpStatus.NO_CONTENT).body("Messages acknowledged successfully");
    }
